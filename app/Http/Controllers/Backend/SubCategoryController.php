...
class SubCategoryController extends Controller
{
    ...
    public function SubSubCategoryView()
    {
        ...
        return view('backend.category.sub_sub_category_view', compact('subsubcategory', 'categories'));
    }
    ...
    public function SubSubCategoryEdit($id)
    {
        ...
        return view('backend.category.sub_sub_category_edit', compact('categories', 'subcategories', 'subsubcategories'));
    }
