...
<head>
  <meta charset="utf-8">
    ...
    <title>E-Commerce Admin - Registration </title>
				...
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed">
                            <form  method="POST" action="{{ route('new.admin.store') }}" role="form">
                                @csrf
                                ...
                                <div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="number" id="phone" name="phone" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Phone">
                                        @error('phone') 
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Already have an account?<a href="{{ route('admin.login')}}" class="text-danger ml-5"> Sign In</a></p>
							</div>
						</div>
					</div>
				</div>
